...
public class TesouroDireto extends Conta {
	...
	public TesouroDireto(String agencia, Cliente titular, String bandeira,double valorAbertura) {
		...
		try {
			...
			System.out.println("N�o � possivel cadastrar essa conta pois o valor � menor que o permitido");
		}
	}
	...
	public void depositar(double valor) {
		...
		} else System.out.println("N�o � permitido depositar valor = 0 ou menor");
	}
}